...
const OurClients = () => {
  const clients = [
    ...
    {
      name: "رئاسة الاستخبارات العامة",
      nameEn: "GIP",
      logo: "/images/gip-logo.svg",
    },
    {
      name: "المنصة الوطنية الموحدة",
      nameEn: "PSS/GID",
        ...
        >
          ...
          >
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <GradientHeading>عملائنا</GradientHeading>
            </motion.div>
            ...
            <Box>
              ...
              >
                نفخر بشراكتنا مع المنظمات التي تتطلع إلى المستقبل وندعم عملائنا الذين يثقون بنا لتحقيق رؤاهم. رحلتنا مبنية على التعاون والابتكار والنجاح المشترك.
              </MotionTypography>
            </Box>
          </MotionBox>
        </MotionStack>
